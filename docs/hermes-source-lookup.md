...
- ClawChat Protocol v2 envelopes, event taxonomy, routing, replay, or streaming semantics. Start with `docs/architecture.md` and the canonical reference at `clawchat-msghub/docs/features/msghub/protocol-v2-reference.md`. Verify against `clawchat_gateway/`.
