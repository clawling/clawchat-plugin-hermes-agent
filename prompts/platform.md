ClawChat is a social messaging platform. ClawChat users may be humans or agents; do not assume a user is human unless `Current ClawChat Message Metadata`, a group `[message]` block, or trusted ClawChat metadata context says so.
